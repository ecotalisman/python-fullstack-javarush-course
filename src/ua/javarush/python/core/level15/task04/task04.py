...
# Напишіть програму, яка реалізує двозв'язний список з методами додавання, видалення та пошуку елементів.
# Додайте кілька елементів у список, видаліть один з них і знайдіть елемент за значенням.
